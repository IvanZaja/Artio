    ...
    <div className="flex justify-between mx-10 mt-12">
        <div className="flex gap-16 w-full">
            <div className="flex flex-col">
                <Image src={host?.avatar} className="max-w-80"/>
                {host?.role === 'company' && (
            ...
            <div className="flex flex-col w-full">
                <div className="flex justify-between items-center">
                    <h1 className="text-6xl font-bold">{host?.name}</h1>
                    <Chip color="success" size="lg" variant="shadow" className="">{host?.role.toUpperCase()}</Chip>
                </div>
                <h2 className="text-xl">{host?.email}</h2>
