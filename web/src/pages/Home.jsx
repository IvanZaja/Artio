            ...
            <footer className='bg-white rounded-lg shadow m-4 dark:bg-gray-800 mt-[125px]'>
                <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                  ...
                  <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
                      <li>
                          <a href="https://github.com/IvanZaja" className="hover:underline me-4 md:me-6">GitHub</a>
                      </li>
                      <li>
                          <a href="https://www.linkedin.com/in/ivan-zaja/" className="hover:underline me-4 md:me-6">LinkedIn</a>
                      </li>
                      <li>
                          <a href="mailto:ivanzaja@hotmail.com" className="hover:underline">Contact</a>
                      </li>
                  </ul>
                </div>
            </footer>
