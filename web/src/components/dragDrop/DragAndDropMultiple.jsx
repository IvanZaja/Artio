  ...
  return (
    <div className="flex flex-col items-center w-full ">
        <div
          ...
          onDragOver={handleDragOver} className={previewUrl ? 'hidden' : "flex w-full rounded-xl lg:h-80 border-2 border-dashed border-gray-400 flex-col items-center justify-center "}>
          <UploadCloudIcon className="h-20 w-20 text-gray-500 dark:text-gray-400" />
          <p className="text-gray-500 dark:text-gray-400 text-center">Drag & Drop<br/>additional images<br/>or click here.</p>
        </div>
        <input
