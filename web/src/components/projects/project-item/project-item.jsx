...
function ProjectItem({ project }) {
  return (
    <Link to={`/projects/${project.id}`}>
      <Card isFooterBlurred className="hidden lg:flex transition ease-in-out hover:-translate-y-1 hover:scale-105 duration-200 w-[370px] h-[450px] col-span-12 mb-5 sm:col-span-5">
        <Image
          removeWrapper
      ...
      <Card className="flex lg:hidden transition ease-in-out hover:-translate-y-1 hover:scale-105 duration-200 w-[370px] h-[450px] mb-5 mx-6">
        <Image
            removeWrapper
            alt="Card example background"
            className="z-0 w-full h-full scale-125 -translate-y-6 object-cover"
